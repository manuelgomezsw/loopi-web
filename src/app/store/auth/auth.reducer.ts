...
export const authReducer = createReducer(
  ...
  on(AuthActions.selectContextSuccess, (state, { workContext, token }): AuthState => ({
    ...state,
    workContext,
    token,
    loading: false,
  ...
  // Session Management
  on(AuthActions.loadStoredSession, (state): AuthState => ({
    ...state,
    loading: true,
    error: null
  })),

  on(AuthActions.sessionLoaded, (state, { user, token, workContext }): AuthState => ({
    ...state,
    user,
    token,
    workContext,
  ...
  on(AuthActions.sessionLoadFailure, (state): AuthState => ({
    ...state,
    loading: false,
    error: null
  })),
