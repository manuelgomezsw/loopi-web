...
export const selectWorkContext = createSelector(
  selectAuthState,
  (state: AuthState) => state.workContext
);
...
export const selectCurrentFranchise = createSelector(
  selectWorkContext,
...
export const selectHasWorkContext = createSelector(
  selectWorkContext,
  (workContext) => !!workContext
);

export const selectIsUserInRole = (role: string) => createSelector(
  selectUserRole,
...
export const selectCanAccessRoute = (requiredPermissions: string[]) => createSelector(
  selectIsAuthenticated,
  selectHasWorkContext,
  selectUserPermissions,
  selectWorkContextPermissions,
