...
export const setSidebarState = createAction('[UI] Set Sidebar State', props<{ open: boolean }>());
...
export const clearComponentLoading = createAction('[UI] Clear Component Loading', props<{ component: string }>());

// Error Actions
export const setGlobalError = createAction('[UI] Set Global Error', props<{ error: string | null }>());
...
export const clearComponentError = createAction('[UI] Clear Component Error', props<{ component: string }>());
